...
# mri-code-debug — systematic debugging
...
1. **Create Failing Test Case**
   ...
   - Use the `mri-code-tdd` skill for writing proper failing tests
...
**Related skills:**
- **mri-code-tdd** - For creating failing test case (Phase 4, Step 1)
- **mri-code-verify** - Verify fix worked before claiming success
...
file if missing — schema in the `/mri-code-resume` command). At the **end**, set it to `[x]` and **return to
the step that called you** (typically `/mri-code-implement`).

---
**User input:** $ARGUMENTS

💡 **Suggested model:** Sonnet (Opus if the cause is stubborn) — see `.mri_code/models.md`.
