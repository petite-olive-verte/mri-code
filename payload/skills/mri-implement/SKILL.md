...
digraph when_to_use {
    ...
    "mri-implement (this skill)" [shape=box];
    "Manual execution or brainstorm first" [shape=box];

    "Have implementation plan?" -> "Tasks mostly independent?" [label="yes"];
    "Have implementation plan?" -> "Manual execution or brainstorm first" [label="no"];
    "Tasks mostly independent?" -> "mri-implement (this skill)" [label="yes"];
...
`mri-devplan` gives each task a **contract** (test code + intent + signature),
...
- **mri-worktrees** - Ensures isolated workspace (creates one or verifies existing)
- **mri-devplan** - Creates the plan this skill executes
- **mri-review** - Code review template for the final whole-branch review
- **mri-finish** - Complete development after all tasks
